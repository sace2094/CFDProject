...
def writeGeoFromXYZVarySizing(a_XYZFile, Inputs, a_ParametricSize=True):
    ...
    with open(geofile,"w+") as geoFile:
        ...
        Fields = f"""
                        ...
                        Field[2].LcMin = E1;
                        Field[2].LcMax = E3;
                        Field[2].DistMin = 0.015 * Chord;
                        Field[2].DistMax = 0.25 * Chord;
                        ...
                        Field[4].VIn  = E1;
                        Field[4].VOut = E3;
                        Field[4].XMin = {-0.3 * Chord};
                        Field[4].XMax = {2 * Chord};
                        Field[4].YMin = {Height - .55 * Chord};
                        Field[4].YMax = {Height + .35 * Chord};
...
boxH = 6 * chord #sets height of bounding box for sim
