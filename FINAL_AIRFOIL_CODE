...
outFileV = 'circle-V-8-LES.xdmf'
outFileP = 'circle-P-8-LES.xdmf'
forceFile = 'circle-forces-8-LES.dat'
imageFile = 'circle-draglift-8-LES.png'
...
def writeGeoFromXYZVarySizing(a_XYZFile, Inputs, a_ParametricSize=True):
    ...
    """
    meshfile = "MeshFile-8.msh"
    geofile = "geometry-8.geo"
...
AOA = -8 # degrees, also will get ranged
